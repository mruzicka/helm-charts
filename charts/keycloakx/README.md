...
| `optimized`                                  | Whether the optimized start is used. When set to `true`, then environment variables specifying build-time options are not set to avoid warnings.                                                                                                                                  | false                                                                                                                               |
